  ...
  <>
    ...
    <Divider speed={0.1} offset={offset}>
      <UpDown>
        ...
        <SVG icon="triangle" width={8} fill={colors['grey-darkest']} left="25%" top="5%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="triangle" width={12} fill={colors.white} left="95%" top="50%" />
      ...
      <SVG icon="hexa" width={8} fill={colors['grey-darkest']} left="80%" top="70%" />
    </Divider>
