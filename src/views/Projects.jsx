  ...
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="triangle" width={8} fill={colors.orange} left="25%" top="5%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="triangle" width={12} fill={colors.white} left="90%" top="30%" />
        <SVG icon="circle" width={16} fill={colors.yellow} left="70%" top="90%" />
        <SVG icon="triangle" hiddenMobile width={16} fill={colors.teal} left="18%" top="75%" />
      ...
      <SVG icon="hexa" width={16} fill={colors.red} left="75%" top="30%" />
      <SVG icon="hexa" width={8} fill={colors.yellow} left="80%" top="70%" />
    </Divider>
  </>
)
